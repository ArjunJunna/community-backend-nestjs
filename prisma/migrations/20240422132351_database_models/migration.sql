...
CREATE TABLE "Subscription" (
    ...
    CONSTRAINT "Subscription_pkey" PRIMARY KEY ("userId","forumId")
);
...
-- AddForeignKey
ALTER TABLE "Subscription" ADD CONSTRAINT "Subscription_forumId_fkey" FOREIGN KEY ("forumId") REFERENCES "Forum"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
